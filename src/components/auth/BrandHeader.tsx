...
export function BrandHeader({ className }: { className?: string }) {
  return (
    <div className={cn('flex flex-col items-center justify-center text-center', className)}>
      <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-primary overflow-hidden bg-white shadow-md mb-4">
        <img src="/brand/icon-512.png" alt="Logo" className="h-full w-full object-contain" />
      </div>
